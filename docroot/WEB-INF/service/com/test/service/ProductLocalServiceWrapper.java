...
public class ProductLocalServiceWrapper implements ProductLocalService,
	...
	*/
	...
	public com.test.model.Product addProduct(java.lang.String productName,
		...
		throws com.liferay.portal.kernel.exception.SystemException {
		return _productLocalService.addProduct(productName, weight, bakerName,
			price, office);
	}

	@Override
	public java.util.List getProductsByOffice(java.lang.String office) {
		return _productLocalService.getProductsByOffice(office);
	}

	@Override
	public java.lang.Boolean deleteProductById(long productId) {
		return _productLocalService.deleteProductById(productId);
	}
