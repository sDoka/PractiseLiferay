...
import com.test.NoSuchProductException;

import com.test.model.Product;
import com.test.model.impl.ProductImpl;
import com.test.model.impl.ProductModelImpl;
...
public class ProductPersistenceImpl extends BasePersistenceImpl<Product>
	...
	public static final FinderPath FINDER_PATH_WITH_PAGINATION_FIND_BY_OFFICE = new FinderPath(ProductModelImpl.ENTITY_CACHE_ENABLED,
			ProductModelImpl.FINDER_CACHE_ENABLED, ProductImpl.class,
	...
	public static final FinderPath FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_OFFICE =
		new FinderPath(ProductModelImpl.ENTITY_CACHE_ENABLED,
			...
			ProductModelImpl.OFFICE_COLUMN_BITMASK);
	public static final FinderPath FINDER_PATH_COUNT_BY_OFFICE = new FinderPath(ProductModelImpl.ENTITY_CACHE_ENABLED,
			ProductModelImpl.FINDER_CACHE_ENABLED, Long.class,
	 ...
	 */
	@Override
	public List<Product> findByOffice(String office) throws SystemException {
		return findByOffice(office, QueryUtil.ALL_POS, QueryUtil.ALL_POS, null);
	}
	 ...
	 */
	@Override
	public List<Product> findByOffice(String office, int start, int end)
		throws SystemException {
		return findByOffice(office, start, end, null);
	}
	...
	public List<Product> findByOffice(String office, int start, int end,
		...
		if ((start == QueryUtil.ALL_POS) && (end == QueryUtil.ALL_POS) &&
			...
			finderArgs = new Object[] { office };
		}
		else {
			finderPath = FINDER_PATH_WITH_PAGINATION_FIND_BY_OFFICE;
			finderArgs = new Object[] { office, start, end, orderByComparator };
		}
		...
		if ((list != null) && !list.isEmpty()) {
			for (Product product : list) {
				if (!Validator.equals(office, product.getOffice())) {
					list = null;
		...
		if (list == null) {
			...
			boolean bindOffice = false;

			if (office == null) {
				query.append(_FINDER_COLUMN_OFFICE_OFFICE_1);
			}
			else if (office.equals(StringPool.BLANK)) {
				query.append(_FINDER_COLUMN_OFFICE_OFFICE_3);
			}
			else {
				bindOffice = true;

				query.append(_FINDER_COLUMN_OFFICE_OFFICE_2);
			}
	 ...
	 */
	@Override
	public Product findByOffice_First(String office,
		OrderByComparator orderByComparator)
		throws NoSuchProductException, SystemException {
		Product product = fetchByOffice_First(office, orderByComparator);
	 ...
	 */
	@Override
	public Product fetchByOffice_First(String office,
		OrderByComparator orderByComparator) throws SystemException {
		List<Product> list = findByOffice(office, 0, 1, orderByComparator);
	 ...
	 */
	@Override
	public Product findByOffice_Last(String office,
		OrderByComparator orderByComparator)
		throws NoSuchProductException, SystemException {
		Product product = fetchByOffice_Last(office, orderByComparator);
	 ...
	 */
	@Override
	public Product fetchByOffice_Last(String office,
		OrderByComparator orderByComparator) throws SystemException {
		int count = countByOffice(office);

		if (count == 0) {
			return null;
		}

		List<Product> list = findByOffice(office, count - 1, count,
				orderByComparator);
	 ...
	 */
	@Override
	public Product[] findByOffice_PrevAndNext(long productId, String office,
		OrderByComparator orderByComparator)
		throws NoSuchProductException, SystemException {
		...
		try {
			...
			array[0] = getByOffice_PrevAndNext(session, product, office,
					orderByComparator, true);

			array[1] = product;

			array[2] = getByOffice_PrevAndNext(session, product, office,
	...
	protected Product getByOffice_PrevAndNext(Session session, Product product,
		String office, OrderByComparator orderByComparator, boolean previous) {
		StringBundler query = null;
	 ...
	 */
	@Override
	public void removeByOffice(String office) throws SystemException {
		for (Product product : findByOffice(office, QueryUtil.ALL_POS,
	 ...
	 */
	@Override
	public int countByOffice(String office) throws SystemException {
		FinderPath finderPath = FINDER_PATH_COUNT_BY_OFFICE;

		Object[] finderArgs = new Object[] { office };
	...
	private static final String _FINDER_COLUMN_OFFICE_OFFICE_1 = "product.office IS NULL";
	private static final String _FINDER_COLUMN_OFFICE_OFFICE_2 = "product.office = ?";
	private static final String _FINDER_COLUMN_OFFICE_OFFICE_3 = "(product.office IS NULL OR product.office = '')";
	...
	@Override
	public Product updateImpl(com.test.model.Product product)
		throws SystemException {
		product = toUnwrappedModel(product);
		...
		if (isNew || !ProductModelImpl.COLUMN_BITMASK_ENABLED) {
			...
			if ((productModelImpl.getColumnBitmask() &
				...
				Object[] args = new Object[] {
						productModelImpl.getOriginalOffice()
					};
				...
				args = new Object[] { productModelImpl.getOffice() };
	...
	protected Product toUnwrappedModel(Product product) {
		...
		productImpl.setWeight(product.getWeight());
		productImpl.setManufactureDate(product.getManufactureDate());
		productImpl.setDateOfSale(product.getDateOfSale());
		productImpl.setBakerName(product.getBakerName());
		productImpl.setPrice(product.getPrice());
		productImpl.setOffice(product.getOffice());
	...
	public void afterPropertiesSet() {
		String[] listenerClassNames = StringUtil.split(GetterUtil.getString(
					com.liferay.util.service.ServiceProps.get(
						"value.object.listener.com.test.model.Product")));
